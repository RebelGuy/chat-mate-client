...
import dev.rebel.chatmate.config.serialised.SerialisedConfigVersions.*;
import dev.rebel.chatmate.config.VersionedData;
import dev.rebel.chatmate.config.serialised.*;
